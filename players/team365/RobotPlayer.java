			...
			try {
				if(rc.getType()==RobotType.HQ){
					...
					if(Clock.getRoundNum()<200){
						moveAround();
					}else if(Clock.getRoundNum()>200&&Clock.getRoundNum()<500){
						buildUnit(RobotType.MINERFACTORY);
						mineAndMove();
						}	
					else if(Clock.getRoundNum()>500&&Clock.getRoundNum()<1200){
							buildUnit(RobotType.BARRACKS);
							moveAround();
						
						}
					else if(Clock.getRoundNum()>1200&&Clock.getRoundNum()<1300){
					...
					else if(Clock.getRoundNum()>1301){
